...
// Phase 4a: Register remaining similarity analysis macros
// (find_similar_materials and cold_start_analogs are now in RegisterSimilaritySearchMacros module)
...
static void LoadInternal(ExtensionLoader &loader) {
	...
	// Use modular similarity search macro registration (find_similar_materials, cold_start_analogs)
	anofox::RegisterSimilaritySearchMacros(conn);
	// Register remaining macros (infer_predecessors, wl_kernel_similarity) - to be modularized in Phase 4
